...
%%   - \listoffigures* removed (no figures in the document)
%%
...
\degree{M.Sc.\ in Blockchain and Distributed Ledger Technologies}
...
\mainmatter
    ...
    \input{chap2/background_main}               % Chapter 2: Background and Related Work
    \input{chap3/research_questions_main}        % Chapter 3: Research Questions and Objectives
    \input{chap4/methodology_main}              % Chapter 4: Methodology and System Design
    \input{chap5/implementation_main}           % Chapter 5: Implementation
    \input{chap6/evaluation_main}               % Chapter 6: Evaluation and Testing
    \input{chap7/results_main}                  % Chapter 7: Results
    \input{chap8/discussion_main}               % Chapter 8: Discussion
    \input{chap9/conclusion_main}               % Chapter 9: Conclusion and Future Work
    \appendix
        \input{appA/appendix_a_main}            % Appendix A: Implementation Challenge Narratives
        \input{appB/appendix_b_main}            % Appendix B: Research Objective Details
        \input{appC/appendix_c_main}            % Appendix C: Code Listings
        \input{appD/appendix_d_main}            % Appendix D: Security and Coverage Findings
        \input{appE/appendix_e_main}            % Appendix E: Future Work Details
        \input{appF/appendix_f_main}            % Appendix F: Work Plan and Timeline
