...
\textbf{Statement.} Implement a unified rights record (originally ink!, revised to FRAME pallet in Phase~4) with off-chain indexing support and access-verification latency measurement.\newline
